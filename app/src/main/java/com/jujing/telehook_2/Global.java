...
public class Global {
    public static final String XPOSED_CODE = "166";//TODO 测试  记得改isDebug！！！
...
//    public static final String CHAT_IDS = storage + "/chat_ids";
    ...
    public static final String SWITCH_NUM_CASH = storage + "/switch_num_cash";
    public static final String SWITCH_NUMS = storage + "/switch_nums/";
    public static final String IS_SENDING = storage + "/is_sending/";

    public static final String SEND_VIDEO_MESSAGE = storage + "/send_video_message333";
